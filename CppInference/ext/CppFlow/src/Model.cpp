...
Model::Model(const char* model_filename, const std::vector<uint8_t>& config_options) {
	...
	this->session = TF_LoadSessionFromSavedModel(sess_opts, RunOpts, model_filename, &tags, ntags, this->graph, NULL, this->status);
