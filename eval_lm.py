...
if __name__ == '__main__':
    ...
    parse.add_argument('--data_config',type=str,default='./transformer-logs/lm_data.yml',help='the lm data config path')
    parse.add_argument('--model_config',type=str,default='./transformer-logs/transformerO2OE.yml',help='the lm model config path')
